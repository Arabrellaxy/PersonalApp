//
//  XYActivityIndicatorAnimationPacman.swift
//  Eat
//
...
class XYActivityIndicatorAnimationPacman: XYActivityIndicatorAnimationDelegate {
    ...
    func pacmanInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw pacman
        let pacman = XYActivityIndicatorShape.pacman.layerWith(size: CGSize(width: pacmanSize, height: pacmanSize), color: color)
        let frame = CGRect(
    ...
    func circleInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        let circle = XYActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        let frame = CGRect(
